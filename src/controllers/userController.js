...
controller.inserts = async (req, res) => {
    try {
        const rawSQL = `
...
(1, 59.99, NULL, CURRENT_TIMESTAMP, 100),
(1, 109.99, 5, CURRENT_TIMESTAMP, 200),
(2, 39.99, NULL, CURRENT_TIMESTAMP, 50),
(2, 69.99, NULL, CURRENT_TIMESTAMP, 100),
(3, 49.99, 5, CURRENT_TIMESTAMP, 50),
(3, 89.99, NULL, CURRENT_TIMESTAMP, 100),
(4, 89.99, NULL, CURRENT_TIMESTAMP, 50),
(4, 159.99, 10, CURRENT_TIMESTAMP, 100),
(5, 19.99, NULL, CURRENT_TIMESTAMP, 50),
(5, 34.99, NULL, CURRENT_TIMESTAMP, 100),
(6, 19.99, NULL, CURRENT_TIMESTAMP, 50),
(6, 34.99, NULL, CURRENT_TIMESTAMP, 100);

INSERT INTO PRICE (ADDONID, PRICE, DISCOUNT_PERCENTAGE, CHANGE_DATE) VALUES 
(1, 9.99, NULL, CURRENT_TIMESTAMP),
(2, 5.99, 10, CURRENT_TIMESTAMP),
(3, 1.99, NULL, CURRENT_TIMESTAMP),
(4, 4.99, NULL, CURRENT_TIMESTAMP),
(5, 4.99, NULL, CURRENT_TIMESTAMP);
...
(1, NULL, '1.0.0', 2, 'Initial release of CreatiVortex with core design tools.', CURRENT_TIMESTAMP, 'https://www.google.pt', 1),
(NULL, 1, '1.1.0', 2, 'Premium Design Templates addon for CreatiVortex.', CURRENT_TIMESTAMP, 'https://www.google.pt', NULL),
(NULL, 2, '1.2.0', 2, 'Enhanced Collaboration Tools addon for CreatiVortex.', CURRENT_TIMESTAMP, 'https://www.google.pt', NULL),
(6, NULL, '1.0.0', 2, 'Initial release of DesignSphere with comprehensive design tools.', CURRENT_TIMESTAMP, 'https://www.google.pt', 6),
(2, NULL, '1.0.0', 2, 'Initial release of TaskMaster with task management features.', CURRENT_TIMESTAMP, 'https://www.google.pt', 2),
(NULL, 3, '1.1.0', 2, 'Time Tracking and Analytics addon for TaskMaster.', CURRENT_TIMESTAMP, 'https://www.google.pt', NULL),
(3, NULL, '1.0.0', 2, 'Initial release of CodeFlow with advanced code editor.', CURRENT_TIMESTAMP, 'https://www.google.pt', 3),
(NULL, 4, '1.1.0', 2, 'Voice Command Integration addon for CodeFlow.', CURRENT_TIMESTAMP, 'https://www.google.pt', NULL),
(4, NULL, '1.0.0', 2, 'Initial release of FunStream with high-quality streaming capabilities.', CURRENT_TIMESTAMP, 'https://www.google.pt', 4),
(NULL, 5, '1.1.0', 2, 'High-Quality Streaming addon for FunStream.', CURRENT_TIMESTAMP, 'https://www.google.pt', NULL),
(5, NULL, '1.0.0', 2, 'Initial release of ChatSphere with communication tools.', CURRENT_TIMESTAMP, 'https://www.google.pt', 5);`;
        // Execute the raw SQL query
        await sequelize.query(rawSQL, { raw: true });

        res.send('SQL executed successfully');
    } catch (error) {
        res.send('Error executing raw SQL:', error);
    }
}
controller.updates = async (req, res) => {
    try {
        const rawSQL = `UPDATE "USER" SET BUSINESSID = 1, UTYPEID = 3 WHERE USERID=1;
...
UPDATE "USER" SET BUSINESSID = 1, UTYPEID = 2 WHERE USERID=6;`
        await sequelize.query(rawSQL, { raw: true });
